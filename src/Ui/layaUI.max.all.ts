...
module Ui.Testv {
    export class TestPageUI extends View {
        ...
        createChildren():void {
            ...
            this.createView(Ui.Testv.TestPageUI.uiView);
...
module Ui {
    export class testViewUI extends View {
		public tList:Laya.List;

        public static  uiView:any ={"type":"View","props":{"width":1280,"height":720},"child":[{"type":"List","props":{"y":0,"x":0,"width":456,"var":"tList","height":423},"child":[{"type":"Box","props":{"y":0,"x":0,"renderType":"render"},"child":[{"type":"Label","props":{"text":"label","name":"mText","fontSize":25,"font":"SimHei","color":"#ffffff","bold":true}}]}]}]};
        constructor(){ super()}
        createChildren():void {
