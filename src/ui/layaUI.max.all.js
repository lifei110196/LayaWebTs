...
var testViewUI=(function(_super){
		function testViewUI(){
			...
			testViewUI.__super.call(this);
		}

		CLASS$(testViewUI,'ui.testViewUI',_super);
		var __proto__=testViewUI.prototype;
		__proto__.createChildren=function(){
		...
		testViewUI.uiView={"type":"View","props":{"width":1280,"height":720},"child":[{"type":"List","props":{"y":0,"x":0,"width":456,"var":"tList","height":423},"child":[{"type":"Box","props":{"y":0,"x":0,"renderType":"render"},"child":[{"type":"Label","props":{"text":"label","name":"mText","fontSize":25,"font":"SimHei","color":"#ffffff","bold":true}}]}]}]};
		return testViewUI;
	})(View);